...
public class EnEnterpriseController implements Serializable {
    ...
    @EJB
    private com.zople.dao.EnEnterpriseFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnEnterpriseCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnEnterpriseUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnEnterpriseDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("PersistenceErrorOccured"));
        }
    }
