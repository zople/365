...
public class EnExhibitionController implements Serializable {
    ...
    @EJB
    private com.zople.dao.EnExhibitionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnExhibitionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnExhibitionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("EnExhibitionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/resources/entreprise/Bundle").getString("PersistenceErrorOccured"));
        }
    }
